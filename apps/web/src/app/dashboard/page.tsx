  ...
  return (
    <div className="min-h-screen bg-surface-0 bg-dot-grid relative flex flex-col">
      ...
      <div className="flex-1 flex relative z-10">
        {/* Sidebar (25%) */}
        <aside className="w-1/4 border-r-4 border-black bg-white/40 backdrop-blur-md p-8 min-h-screen">
        ...
        <main className="w-3/4 p-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="font-display text-7xl font-black text-ink mb-12 uppercase italic tracking-tighter leading-[0.85]">
              Control Center
            </p>
            ...
            <div className="mt-16 bg-white border-4 border-black p-12 shadow-[10px_10px_0px_0px_#000]">
              <h2 className="font-display text-3xl font-black text-ink mb-6 uppercase italic">
                System Status
              </h2>
